function code128generator(data, canvas) {
	let renderElements = "";
	// 校验位的第一步
	...
	*/
	...
	if (canvas instanceof Element && canvas.tagName == "CANVAS") {
		...
		ctx.fillRect(-1, -1, width + 2, heigth + 2);
		ctx.fillStyle = "#000000";
		for (i of renderElements) {
			if (i == '1') {
				ctx.fillRect(x, 0, step, heigth - 25);
			}
			x += step;
		}
	}
